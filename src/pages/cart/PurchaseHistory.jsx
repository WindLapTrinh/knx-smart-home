          ...
          <Box className="slider-history bg-white p-4">
            <div className="tabs-wrapper">
              <Tabs
                ...
                id="purchase-history-tabs"
                scrollable="true"
              >
                <Tabs.Tab key="tab1" label="Tất cả">
                  <UpdateCart />
                </Tabs.Tab>
                <Tabs.Tab key="tab2" label="Đang xử lý"></Tabs.Tab>
                <Tabs.Tab key="tab3" label="Đang giao"></Tabs.Tab>
                <Tabs.Tab key="tab4" label="Đã hoàn thành"></Tabs.Tab>
                <Tabs.Tab key="tab5" label="Đã hủy"></Tabs.Tab>
                <Tabs.Tab key="tab6" label="Hoàn trả"></Tabs.Tab>
              </Tabs>
            </div>
          </Box>
